...
from face_align.PIPNet.FaceBoxesV2.faceboxes_detector import *
...
from face_align.PIPNet.lib.networks import *
from face_align.PIPNet.lib.functions import *
from face_align.PIPNet.reverse_index import ri1, ri2
...
def get_lmk_model(model_dir):
    ...
    net = net.to(device)
    weight_file = model_dir + '/epoch59.pth'
    state_dict = torch.load(weight_file, map_location=device)
    net.load_state_dict(state_dict)

    detector = FaceBoxesDetector(
        "FaceBoxes",
        model_dir+"/FaceBoxesV2.pth",
        use_gpu=True,
        device=device,
    )
    return net, detector
